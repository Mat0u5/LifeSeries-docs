...
Randomizing superpowers while some are pre-assigned now gives more randomized results.<br>
'/superpower randomize' now has an optional '<player/s>' argument.

----------

You can now access the following information through vanilla:<br>
Boogeyman players - tag<br>
Secret Society members - tag<br>
Active Wildcards - scoreboard<br>
Active Player Superpowers - scoreboard<br>
Player Task Difficulties - scoreboard<br>
Session info - scoreboard<br>
